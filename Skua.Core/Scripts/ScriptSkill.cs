...
public partial class ScriptSkill : IScriptSkill
{
    ...
    private readonly Lazy<IScriptSelfAuras> _lazySelfAuras;
    ...
    private IScriptSelfAuras SelfAuras => _lazySelfAuras.Value;
    ...
    public ScriptSkill(
        ...
        Lazy<IScriptSelfAuras> selfAuras)
    {
        _lazyFlash = flash;
        _lazyPlayer = player;
        _lazyCombat = combat;
    ...
    public void Start()
    {
        ...
        {
            BaseProvider = new AdvancedSkillProvider(Player, Combat, SelfAuras);
    ...
    {
        OverrideProvider = new AdvancedSkillProvider(Player, Combat, SelfAuras);
